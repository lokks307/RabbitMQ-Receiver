...
Exchange Name: msv-saas-message-subs-logs
Routing key: msv-saas-message-subs-key
...
/*
sudo docker build -t msv-saas-message-subs:0.0.1 .

sudo docker run -d --name msv-saas-message-subs \
-v ~/logs/msv-saas-message-subs-logs:/app/logs/msv-saas-message-subs-logs \
msv-saas-message-subs:0.0.1
*/
package main
import (
	"log"
...
func main(){
	exchangeName := "msv-saas-message-subs-logs"
	routingKey := "msv-saas-message-subs-key"
	...
	queue, err := ch.QueueDeclare(
		"msv-saas-message-subs-queue", // name
		false,                // durable
