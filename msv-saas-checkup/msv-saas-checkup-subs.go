...
Exchange Name: msv-saas-checkup-subs-logs
Routing key: msv-saas-checkup-subs-key
...
/*
sudo docker build -t msv-saas-checkup-subs:0.0.1 .

sudo docker run -d --name msv-saas-checkup-subs \
-v ~/logs/msv-saas-checkup-subs-logs:/app/logs/msv-saas-checkup-subs-logs \
msv-saas-checkup-subs:0.0.1
*/
package main
import (
	"log"
...
func main(){
	exchangeName := "msv-saas-checkup-subs-logs"
	routingKey := "msv-saas-checkup-subs-key"
	...
	queue, err := ch.QueueDeclare(
		"msv-saas-checkup-subs-queue", // name
		false,                // durable
